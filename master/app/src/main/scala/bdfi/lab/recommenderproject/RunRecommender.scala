...
object RunRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //val base = "hdfs://10.0.1.9:8020/datasetFiles/"
    ...
    runRecommender.model(rawUserArtistData, rawArtistData, rawArtistAlias, input)
    runRecommender.evaluate(rawUserArtistData, rawArtistAlias)
    runRecommender.recommend(rawUserArtistData, rawArtistData, rawArtistAlias, input)
  }
