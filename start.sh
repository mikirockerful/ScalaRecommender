...
echo "Cointainer is $CONTAINER_ID"
docker exec -it $CONTAINER_ID_MASTER spark-submit --master spark://master:7077 --class bdfi.lab.recommenderproject.RunRecommender /ScalaRecommender/target/scala-2.11/recommender_2.11-2.0.0.jar
